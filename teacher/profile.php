...
<html>
    <head>
        ...
        <!-- App title -->
        <title><?php echo $emp_name; ?> Profile</title>
		...
		<div class="col-md-3">
			<div class="profile-sidebar">
				...
				<div class="profile-usertitle">
					<img editable src="<?php echo "../admin/controllers/".$image_url; ?>" class="img-responsive" alt="" height="200" width="200" />
				</div>
				<!-- END SIDEBAR USERPIC -->
				<!-- SIDEBAR USER TITLE -->
				<div class="profile-usertitle">
				...
				<div class="profile-usermenu">
					<ul class="nav">
						<li class="active">
							<!-- <a href="updateemployee.php?emp_id=<?php echo $emp_id; ?>">
