...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            function deletePractical(pract_id) {
                //alert(emp_id);
                if(confirm("Are you sure you want to delete practical?")){
                    ...
                    xmlhttp.open("GET", "controllers/deletePractical.php?q="+pract_id, true);
                    xmlhttp.send();
                }
                 else {
                    ...
                    <!-- sample modal content -->
                            <div id="myModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <h4></h4>
                                            <form role="form" data-parsley-validate novalidate action="controllers/addPractical.php" method="get">
                            
                                           <div class="form-group row">
                                                <label for="name" class="col-sm-4 form-control-label">Practical Name<span class="text-danger">*</span></label>
                                                <div class="col-sm-7">
                                                    <input name="pract_name" type="text" required parsley-type="text" class="form-control"
                             ...
                             <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input name="pract_fee" type="number" required parsley-type="number" class="form-control"
                                ...
                                if ($result->num_rows > 0) {
                                    ...
                                    while($row = $result->fetch_assoc()) {
                                        ...
                                        echo "<tr><td>"
                                               ...
                                               /* ."<td width=230>
                                        <a class='btn btn-success' href='updatepractical.php?param1=$pract_id'>Update</a>
                                        
                                        <button type='button' class='btn btn-danger' onclick='deletePractical($pract_id)'>Delete</button>*/
