<?php include 'controllers/authentication_co.php';?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
        ...
        <script type="text/javascript">
            ...
            function deleteCourse(course_id) {
                ...
                if(confirm("Are you sure you want to delete course?")){
                    ...
                    xmlhttp.open("GET", "controllers/deleteCourse.php?q="+course_id, true);
                    xmlhttp.send();
                }
                 else {
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="btn-group pull-right m-t-15">
                            <!-- Large modal -->
                                <!-- <button class="btn btn-primary waves-effect waves-light" data-toggle="modal" data-target="#myModal">Create Course</button> -->
                    ...
                    <!-- sample modal content -->
                            <div id="myModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <h4></h4>
                                            <form role="form" data-parsley-validate novalidate action="controllers/addCourse.php" method="get">
                            
                                           <div class="form-group row">
                                                <label for="name" class="col-sm-4 form-control-label">Course Name<span class="text-danger">*</span></label>
                                                <div class="col-sm-7">
                                                    <input name="course_name" type="text" required parsley-type="text" class="form-control"
                             ...
                             <div class="form-group row">
                                                <label for="phone" class="col-sm-4 form-control-label">Course Fees<span class="text-danger">*</span></label>
                                                <div class="col-sm-7">
                                                    <input name="course_fee" type="number" required parsley-type="number" class="form-control"
                                                           id="name" placeholder="Fee">
                                                </div>
                                            </div>
                            ...
                            <?php 
                                ...
                                if ($result->num_rows > 0) {
                                    ...
                                    while($row = $result->fetch_assoc()) {
                                        ...
                                        /*<a class='btn btn-success' href='updatecourse.php?param1=$course_id'>Update</a>
                                        
                                        <button type='button' class='btn btn-danger' onclick='deleteCourse($course_id)'>Delete</button>*/
