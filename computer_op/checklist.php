        ...
        <div class="wrapper">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="card-box">
                            <h4 class="header-title m-t-0">Websites</h4>
                           ...
                           <div class="table-rep-plugin">
                                <div class="table-responsive" data-pattern="priority-columns">
                                    <table id="tech-companies-1" class="table table-striped table-bordered">
                                        <thead class="thead-default">
                                            <tr>
                                                <th>Websites</th>
                                                <th data-priority="1">Visit</th>
                                                
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                                                <th> <span class="co-name">MJPRU Notices</span></th>
                                                <td>Go</td>
                                                
                                            </tr>
                                            <tr>
                                                <th> <span class="co-name">UP Scholorship</span></th>
                                                <td>Go</td>
                                            </tr>
                                            <tr>
                                                <th> <span class="co-name">NCTE India</span></th>
                                                <td>Go</td>
                                            </tr>
                                            <tr>
                                                <th> <span class="co-name">NRC NCTE Jaipur</span></th>
                                                <td>Go</td>
                                            </tr>
                              ...
                              <h4 class="header-title m-t-0">Emails</h4>

                           <div class="table-rep-plugin">
                                <div class="table-responsive" data-pattern="priority-columns">
                                    <table id="tech-companies-2" class="table table-striped table-bordered">
                                        <thead class="thead-default">
                                            <tr>
                                                <th>Email ids</th>
                                                <th data-priority="1">Password- hidden for security purpose</th>
                                                
                                            </tr>
                                        </thead>
                                        <tbody>
                                                <th> <span class="co-name">rrsmdegreecollege@gmail.com</span></th>
                                                <td>*********</td>
                                                
                                            </tr>
                                            <tr>
                                                <th> <span class="co-name">institutehimalaya@gmail.com</span></th>
                                                <td>********</td>
                                            </tr>
                                     <tr>
                                                <th> <span class="co-name">jags9719@gmail.com</span></th>
                                                <td>********</td>
                                            </tr>
