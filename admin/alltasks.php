        ...
        <script type="text/javascript">
            ...
            function deleteTask(task_id) {
                ...
                if(confirm("Are you sure you want to delete?")){
                    ...
                    xmlhttp.open("GET", "controllers/deleteTask.php?q="+task_id, true);
                    xmlhttp.send();
                }
                 else {
                                    ...
                                    while($row = $result->fetch_assoc()) {
                                        ...
                                        echo "</td>";
                                                ...
                                                elseif ($status == "Completed"){
                                                    ...
                                                    echo "<td><span class='label label-danger'>Not Comlpeted</span></td>";
                                                }

                                              echo "<td width=230>
                                        <a  class='btn btn-primary waves-effect waves-light' href='viewtask.php?task_id=$task_id'>View</a>
                                       
                                        <a class='btn btn-success' href='managetask.php?task_id=$task_id&emp_name=$emp_name'>Manage</a>
                                        
                                        <button type='button' class='btn btn-danger' onclick='deleteTask($task_id)'>Delete</button>
