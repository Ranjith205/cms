            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="btn-group pull-right m-t-15">
                           <a href="subjects.php">  <button type="button" class="btn btn-primary waves-effect waves-light">Go Back</button></a>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <form role="form" data-parsley-validate novalidate action="controllers/updateSubject.php" method="get">

                            <?php 
                                include '../database/db_config.php'; 
                                $subject_id = $_GET['param1'];
                                /*echo "Emp id ".$emp_id;*/
                            ...
                            ?>
                                <input type="hidden" name="subject_id" value="<?php echo $subject_id; ?>">
                                           ...
                                           <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input name="subject_name" type="text" value="<?php echo $subject_name; ?>" parsley-type="text" class="form-control" id="name" placeholder="name">
                                                </div>
                                            </div>
