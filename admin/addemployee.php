                ...
                xmlhttp.onreadystatechange = function() {
                    if (this.readyState == 4 && this.status == 200) {
                        if(this.responseText === "no"){
                            ...
                            document.getElementById("txtHint").innerHTML = "Username already exists";   
                            return false;
                        }
                        
                    }
                }
                xmlhttp.open("GET", "controllers/checkUsername.php?q="+email, true);
                xmlhttp.send();
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <form data-parsley-validate novalidate action="controllers/addEmployee.php" method="post" enctype="multipart/form-data" >
                              <div class="form-group row">
                                 ...
                                 <div class="col-sm-7">
                                           ...
                                           <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input name="emp_name" type="text" required parsley-type="text" class="form-control"
                            ...
                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input name="userpic" type="file" required accept="image/*" parsley-type="file" class="form-control" id="userpic" placeholder="name" onchange="upload(this.value)">
                                                </div>
                                            </div>
                             ...
                             <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input name="doj" type="date" required parsley-type="text" class="form-control" id="name" placeholder="">
                                                </div>
                                            </div>
                            ...
                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input name="subject" type="text" required parsley-type="text" class="form-control" id="name" placeholder="Subject">
                                </div></div>
                          
                             <div class="form-group row">
                                                <label for="phone" class="col-sm-4 form-control-label">Phone no.<span class="text-danger">*</span></label>
                                                <div class="col-sm-7">
                                                    <input name="phone" type="number" required parsley-type="number" class="form-control" id="name" placeholder="mobile no.">
                                                </div>
                                            </div>
                            ...
                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input name="aadhar" type="number" parsley-type="number" class="form-control"
                             ...
                             <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input name="address" type="text" required parsley-type="text" class="form-control"
                                                           id="name" placeholder="Address">
                                                </div>
                                            </div>
                                        <div class="form-group row">
                                        <div class="col-sm-7">
                                            <font color='red'><b><span id="txtHint"></span></b></font>
                                            </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="inputEmail3" class="col-sm-4 form-control-label">Email<span class="text-danger"></span></label>
                                                <div class="col-sm-7">
                                                    <input name="email" type="email" parsley-type="email" class="form-control" id="inputEmail3" placeholder="Email" >
                                                   
                                                </div>
                                            </div>
                                             <div class="form-group row">
                                                <label for="name" class="col-sm-4 form-control-label">User Name<span class="text-danger">*</span></label>
                                                <div class="col-sm-7">
                                                    <input name="user_name" type="text" required parsley-type="text" class="form-control" id="user_name" placeholder="Username" onblur ="checkUsername()">
                                                </div>
                                            </div>
                                            <div class="form-group row">
