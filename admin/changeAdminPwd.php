            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <form role="form" data-parsley-validate novalidate action="controllers/changeAdminPwd.php" method="post" enctype="multipart/form-data">
                             
                                         
                                  <div class="form-group row">
                                        <label for="password" class="col-sm-4 form-control-label">Password<span class="text-danger">*</span></label>
                                        <div class="col-sm-7">
                                            <input name="pwd" type="password" parsley-type="text" class="form-control" id="pwd">
                        </div></div>
                        <div class="form-group row">
                                        <label for="cpassword" class="col-sm-4 form-control-label">Confirm Password<span class="text-danger">*</span></label>
                                        <div class="col-sm-7">
                                            <input name="cpwd" type="password" parsley-type="text" class="form-control" id="cpwd">
                        </div></div>
