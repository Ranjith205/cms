            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="btn-group pull-right m-t-15">
                           <a href="courses.php">  <button type="button" class="btn btn-primary waves-effect waves-light">Go Back</button></a>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <form role="form" data-parsley-validate novalidate action="controllers/updateCourse.php" method="get">

                            <?php 
                                include '../database/db_config.php'; 
                                $course_id = $_GET['param1'];
                                /*echo "Emp id ".$emp_id;*/
                            ...
                            ?>
                                <input type="hidden" name="course_id" value="<?php echo $course_id; ?>">
                                           ...
                                           <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input name="course_name" type="text" value="<?php echo $course_name; ?>" parsley-type="text" class="form-control" id="name" placeholder="name">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input name="course_fee" type="number" value="<?php echo $course_fee; ?>" parsley-type="number" class="form-control" id="name" placeholder="mobile no.">
                                                </div>
                                            </div>
