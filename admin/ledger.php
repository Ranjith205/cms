...
<html>
    <head>
        ...
        <!-- App title -->
        <title>Ledger of <?php echo $data['name'];?></title>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <h4 class="page-title">Ledger of <?php echo $data['name'];?> </h4>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-xs-12">
					    ...
					    <label class="col-sm-4 form-control-label">Account name</label>
                             <div class="col-sm-7">
					    <input  class="form-control" type="text"  placeholder="name" readonly="readonly"  value="<?php echo $data['name'];?>">
					    ...
					    <label class="col-sm-4 form-control-label">Ledger ID</label>
					      <div class="col-sm-2">
					      	...
					      	<input name="id" class="form-control" type="text" readonly="readonly"  placeholder="id" id="disabledInput"  value="<?php echo $data['id'];?>">	
					    </div>
					  </div>
