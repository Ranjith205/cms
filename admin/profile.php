		...
		<div class="col-md-3">
			<div class="profile-sidebar">
				...
				<div class="profile-usertitle">
					<img src="controllers/userpics/admin.JPG" class="img-responsive" alt="" height="200" width="200">
				</div>
				<!-- END SIDEBAR USERPIC -->
				<!-- SIDEBAR USER TITLE -->
				<div class="profile-usertitle">
				...
				<div class="profile-usermenu">
					<ul class="nav">
						<li class="active">
							<a href="updateemployee.php?user_name=admin">
							<i class="glyphicon glyphicon-home"></i>
							Edit Profile </a>
						</li>
                        <li>
                            <a href="changeAdminPwd.php">
